...
public interface j_jpa_useragent extends JpaRepository<Useragent, Integer>
{
    ...
    @Query(value="select count(u.stbrowser) as count, month(u.datum) as month, year(u.datum) as year from useragent u where YEAR(u.datum) = :year group by month and year", nativeQuery = true)
